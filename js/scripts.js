// Google Analytics ------------------
var _gaq = _gaq || [];_gaq.push(['_setAccount', 'UA-8195328-7']);_gaq.push(['_setDomainName', 'i.xiumu.org']);_gaq.push(['_trackPageview']);(function() {var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true;ga.src = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + '.google-analytics.com/ga.js';var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);})();
// 所有函数 ------------------
function init() {    
    "use strict";
    // window load  ------------------
    ...
    $.post("http://dev.xiumu.org/hi/weibo.php", function(a){
        ...
        $(".weibo-holder .next-slide").on("click", function() {
            ts.trigger("next.owl.carousel");
        });
        $(".weibo-holder .prev-slide").on("click", function() {
    ...
    $("#contactform").submit(function() {
        ...
        $("#message").slideUp(750, function() {
            ...
            $.post(a, {
                ...
                //if (null != a.match("成功")) $("#contactform").slideDown("slow");
            });
        });
        return false;
    });
...
function initparallax() {
    ...
    trueMobile = a.any();
    if (trueMobile) {
        $('.hero-wrapper').css("height",$(window).height()+"px"); //地址栏导致屏幕跳跃Fix
